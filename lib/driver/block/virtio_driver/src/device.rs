// ============================================
// VirtioBlkDevice implementation
// ============================================
...
impl VirtioBlkPci {
    ...
    pub unsafe fn new(
        ...
        driver_core::debug("VirtIO PCI: scanning capabilities...");
        ...
        driver_core::debug(&alloc::format!("VirtIO PCI: found {} caps", caps.len()));
        ...
        driver_core::debug(&alloc::format!(
    ...
    unsafe fn init_device(
        ...
        driver_core::debug(&alloc::format!("VirtIO PCI: features={:#x}", features));
        ...
        driver_core::debug(&alloc::format!("VirtIO PCI: queue_max={}", queue_size_max));
    ...
    unsafe fn do_request(
        ...
        *(status_virt as *mut u8) = 0xFF;
        ...
        loop {
            ...
            timeout -= 1;
            if timeout == 0 {
                driver_core::debug("VirtIO: timeout");
