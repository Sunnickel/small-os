...
use crate::block::ahci::AhciBlockDevice;
use crate::block::ahci::port::PortState;
use crate::block::virtio::{VirtioBlkDriver, VirtioBlkState};
...
impl BlockDeviceEnum {
	...
	pub fn from_ahci_port(port_idx: u8, state: PortState, sectors: u64) -> Self {
		Self::Ahci(Box::new(AhciPortWrapper {
			port_idx,
			state,
