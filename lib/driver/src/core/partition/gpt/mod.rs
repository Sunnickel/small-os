...
pub(crate) const GPT_REVISION: [u8; 4] = [0x00, 0x00, 0x01, 0x00];
pub(crate) const GPT_HEADER_SIZE: u32 = 92;
pub(crate) const GPT_ENTRY_SIZE: u32 = 128;
pub(crate) const GPT_MAX_ENTRIES: u32 = 128;
